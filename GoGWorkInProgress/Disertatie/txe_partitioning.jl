...
#! TO ADD PARTITIONING BY R_T RATIO!!!
...
function TXE_partitioning(txe_partitioning_type, A₀, Z₀, A_H_min, A_H_max, Eₙ, fragmdomain, txe_partitioning_datafile, tkerange, density_parameter_type, density_parameter_datafile, dm)
    if txe_partitioning_type == "MSCZ"
        E_excitation = TXE_partitioning_MSCZ(A₀, Z₀, A_H_min, A_H_max, Eₙ, fragmdomain, txe_partitioning_datafile, tkerange, density_parameter_type, density_parameter_datafile, dm)
    elseif txe_partitioning_type == "PARAM"
        E_excitation = TXE_partitioning_PARAM(A₀, Z₀, A_H_min, A_H_max, Eₙ, fragmdomain, txe_partitioning_datafile, tkerange, dm)
    end
    return E_excitation
end