...
t_R = 86400*365/2 # Timpul de emisie in secunde
t_zile = t_R/86400
...
if t_R <= 3600
    ...
    Reprezinta_Suprafata(x, y, χ_Q, x[Int(dim_transversal/2 + 1)], "χ/Q (s/m^3)")
    Reprezinta_Gradient(x, y, χ_Q, x[Int(dim_transversal/2 + 1)], "χ/Q (s/m^3)")
    Reprezinta_Contur(x, y, χ_Q, x[Int(dim_transversal/2 + 1)], "χ/Q (s/m^3)")

    Reprezinta_Suprafata(x, y, χ, x[Int(dim_transversal/2 + 1)], "χ (Bq s/m^3)")
    Reprezinta_Gradient(x, y, χ, x[Int(dim_transversal/2 + 1)], "χ (Bq s/m^3)")
    Reprezinta_Contur(x, y, χ, x[Int(dim_transversal/2 + 1)], "χ (Bq s/m^3)")

    Reprezinta_Suprafata(x, y, ω, x[Int(dim_transversal/2 + 1)], "ω (Bq/m^2)")
    Reprezinta_Gradient(x, y, ω, x[Int(dim_transversal/2 + 1)], "ω (Bq/m^2)")
    Reprezinta_Contur(x, y, ω, x[Int(dim_transversal/2 + 1)], "ω (Bq/m^2)")
elseif t_R <= 86400
    ...
    Reprezinta_Suprafata(x, y, χ_Q, x[1], "χ/Q (s/m^3)")
    Reprezinta_Gradient(x, y, χ_Q, x[1], "χ/Q (s/m^3)")
    Reprezinta_Contur(x, y, χ_Q, x[1], "χ/Q (s/m^3)")

    Reprezinta_Suprafata(x, y, χ, x[1], "χ (Bq s/m^3)")
    Reprezinta_Gradient(x, y, χ, x[1], "χ (Bq s/m^3)")
    Reprezinta_Contur(x, y, χ, x[1], "χ (Bq s/m^3)")

    Reprezinta_Suprafata(x, y, ω, x[1], "ω (Bq/m^2)")
    Reprezinta_Gradient(x, y, ω, x[1], "ω (Bq/m^2)")
    Reprezinta_Contur(x, y, ω, x[1], "ω (Bq/m^2)")
end
